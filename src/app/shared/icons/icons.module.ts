...
import { ArrowForwardIconComponent } from './arrow-forward-icon/arrow-forward-icon.component';
...
import { WhatshotIconComponent } from './whatshot-icon/whatshot-icon.component';
